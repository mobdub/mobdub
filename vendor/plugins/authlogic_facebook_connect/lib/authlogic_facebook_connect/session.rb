    ...
    module Methods
      ...
      def validate_by_facebook_connect
        ...
        if self.attempted_record
          ...
          # TODO: omarkarim edit to avoid extra validation check
          self.attempted_record.save(false)
        
        # TODO: omarkarim edit since email mapping wasn't working
        ...
        unless self.attempted_record || facebook_skip_new_user_creation || errors.on(:facebook)
          begin
            ...
            new_user.map_facebook_info(facebook_session) if new_user.respond_to?(:map_facebook_info)
            ...
            if facebook_valid_user
              ...
              # TODO: omarkarim edit to avoid double save which should be submitted as a patch
      ...
      def authenticating_with_facebook_connect?
        # TODO: omarkarim edit which should be submitted as a patch
        return false if controller.params[:login_with_facebook].blank?
